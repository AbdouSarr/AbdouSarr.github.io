...
$(document).ready(function() {
    ...
    function sectionimage(anchorLink, index){
        ...
        if (index == 4){
            $("#left4").vegas({
                slides: [
                  { src: "./img/background-left3.jpg" },//MAIN BACKGROUND
            ...
            $("#right4").vegas({
                slides: [
                { src: "./img/background-right3.jpg" },//MAIN BACKGROUND
